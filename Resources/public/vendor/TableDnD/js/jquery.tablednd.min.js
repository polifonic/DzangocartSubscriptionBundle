...
$.tableDnD.makeDraggable(this);});},mouseCoords:function(e){if(event.changedTouches)
return{x:event.changedTouches[0].clientX,y:event.changedTouches[0].clientY};if(e.pageX||e.pageY)
...
return data;}};jQuery.fn.extend({tableDnD:$.tableDnD.build,tableDnDUpdate:$.tableDnD.updateTables,tableDnDSerialize:$.proxy($.tableDnD.serialize,$.tableDnD),tableDnDSerializeAll:$.tableDnD.serializeTables,tableDnDData:$.proxy($.tableDnD.tableData,$.tableDnD)});}(jQuery,window,window.document);